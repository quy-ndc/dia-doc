        ...
        <View className='flex-row p-3 justify-between items-center'>
            <View className='flex-row gap-4 items-center'>
                ...
                <View className='flex-col gap-2'>
                    <Text className='text-xl font-bold tracking-wider'>{profile.fullName}</Text>
                    <View className='flex-row gap-2 items-center'>
                        <Phone className='text-[--fade-text-color]' size={14} />
                        <Text className='text-base text-[--fade-text-color] tracking-wider capitalize'>{profile.phoneNumber}</Text>
                    </View>
                    <View className='flex-row gap-2 items-center'>
