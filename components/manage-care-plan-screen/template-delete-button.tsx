...
import { useDeleteCarePlanTemplateMutation } from '../../service/query/user-query'
...
export default function TemplateDeleteButton({ id }: Prop) {

    const [visible, setVisible] = useState(false)

    const { mutateAsync, data, isLoading, isError } = useDeleteCarePlanTemplateMutation()
