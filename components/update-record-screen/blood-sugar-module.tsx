...
import { useUpdateUserBloodSugarMutation, useUpdateUserHbA1cMutation, useUpdateUserWeightMutation } from '../../service/query/user-query'
...
export default function BloodSugarUpdateModule({ type, lastMesurement }: Props) {
