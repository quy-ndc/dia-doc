...
import { useUpdateUserHbA1cMutation, useUpdateUserWeightMutation } from '../../service/query/user-query'
...
export default function Hb1AcUpdateModule({ type, lastMesurement }: Props) {
